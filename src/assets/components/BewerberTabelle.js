  ...
  return (
    <div className="p-8 BewerberTabelle" style={{ maxWidth: '900px', margin: '0 auto' }}>
      <table className="w-full text-sm">
        ...
        <tbody>
          {eintraege.length === 0 ? (
            <tr><td colSpan={6} style={{textAlign:'center', color:'#bbb', padding:'32px 0', fontSize:'0.95rem'}}>Keine Einträge gefunden</td></tr>
            ...
            >
              ...
              <td className="py-2">{formatDate(eintrag.datum)}</td>
